...
The hash table makes anagram lookups easy. To find an alphagram for a word the server simply finds it's alphagram, looks it up in the hash table, and returns the set.